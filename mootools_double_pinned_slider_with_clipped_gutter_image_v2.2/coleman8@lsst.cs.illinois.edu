...
var Slider = new Class({
	...
	setMin: function(stepMin){
		...
		this.bkg.style.clip = "rect(0px "+  (parseInt(this.toPosition(this.step)) +3) + "px 280px 0px)";
	...
	setMax: function(stepMax){
		...
		this.bkg.style.clip = "rect(0px "+  r + "px 280px "+ this.clip_l + "px)";
	...
	checkStep: function(mx){
		...
		if(this.maxknob!=null) {
			...
			this.bkg.style.clip = "rect(0px "+  (parseInt(this.drag.value.now[this.z]) +3)  + "px 280px 0px)"  
